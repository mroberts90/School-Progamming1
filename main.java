...
public class Chapter2PPMatthewRoberts {
	...
	public static void main(String[] args) {
		...
		days = scan.nextInt();// the number that the user inputs for days away from pet will be used in the
								// days variable.
		scan.nextLine();
		...
		System.out.println("Hello, my name is # and I am age ! years old.".replace('#', name).replace("!", String.valueOf(age)));
		...
		System.out.println("And that is an unbelievable " + Duration.ofDays(days).toSeconds() + " seconds.");
		System.out.println("I have missed saying " + phrase + " for " + days + " days.");
		final String message = "Even if I say it every week, not everyday,";
